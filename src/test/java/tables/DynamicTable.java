...
import io.github.bonigarcia.wdm.WebDriverManager;
	...
	public class DynamicTable {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			{
				if(total_pages>1)//even if it is 1 then we no need to do pagination we can direct capture the data 
				{
					WebElement active_Page=driver.findElement(By.xpath("//ul[@class='pagination']//li//*[text()="+p+"]"));//it will click on current page	
